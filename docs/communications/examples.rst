...
.. note::
  The ``time`` field will be set to zero for the examples. Please `see this information <implementation.html#setting-time>`__ to learn how to set the time field. It is very easy to set up for the vehicle.
